...
WORKDIR /opt
USER root
RUN dpkg --add-architecture i386 && apt update && apt install -y python-pip openssh-server git locales ruby tmux sudo  libc6:i386 libncurses5:i386 libstdc++6:i386 ruby-dev && rm -rf /var/lib/apt/lists/* \
